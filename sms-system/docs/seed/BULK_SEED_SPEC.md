...
**Revised from the original estimate below** now that Phases 3-7 are implemented and Phase 4 finalized the subject design (12 subjects: 8 institution-wide "core" + 4 class-scoped "elective", each class taking exactly 1 elective → **9 subjects/student**, not the ~8 originally assumed) — see [§7.2](#72-phase-3-7-corrections-and-finalized-design-verified-against-actual-form-components) for the full list of corrections this uncovered. `results`/`feedback_comments` (Phase 8/9) are still unbuilt — their rows below are projections updated for the 9-subject figure, not yet measured; every other changed row _is_ a measured, dry-run-verified count.
...
| `subjectAttendance`                                                                        | ~8,000–10,000       | 378 subject-class pairings (now exact — 8 core × 42 classes + 42 elective pairs) × scheduled sessions/term — Phase 11 not yet built, session frequency unfinalized                      |
...
| **Total**                                                                                  | **~96,000–100,000** | Up from the original ~87,000–95,000 — see [§7.2](#72-phase-3-7-corrections-and-finalized-design-verified-against-actual-form-components) for why                                        |
...
```text
~98,000 total writes ÷ 10,000/day ≈ 10 daily runs to completion
```
