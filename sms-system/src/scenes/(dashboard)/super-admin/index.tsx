...
import { Plus, Megaphone, Settings, MoreHorizontal, type LucideIcon } from "lucide-react";
...
const quickActions: { label: string; Icon: LucideIcon; href: string; colorClasses: string }[] = [
  {
    label: "Onboard Institution",
    Icon: Plus,
    href: "/dashboard/onboard-institution",
    colorClasses:
    ...
    <div className="p-4 grid grid-cols-12 gap-4">
          ...
          return (
            ...
            >
              <div className="flex justify-between items-center">
                ...
                <MoreHorizontal className="w-4 h-4 opacity-40 text-gray-500 dark:text-gray-400" />
              </div>
      ...
      <div className="col-span-12 grid grid-cols-2 sm:grid-cols-4 gap-3">
        {quickActions.map((action) => (
          ...
          >
            <action.Icon aria-hidden="true" className="w-4 h-4 shrink-0" />
