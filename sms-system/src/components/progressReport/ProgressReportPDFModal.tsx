  ...
  <div className="fixed inset-0 z-50 flex flex-col bg-black/80">
    <div className="flex items-center justify-between px-4 py-2 bg-gray-900 text-white text-sm">
      ...
      <div className="flex items-center gap-3">
        ...
        >
          <PDFDownloadLink
            document={<ProgressReportPDF data={data} />}
            fileName={`progress-report-${data.studentName.replace(/,?\s+/g, '-')}-${data.termName.replace(/\s+/g, '-')}.pdf`}
...
export default ProgressReportPDFModal;
